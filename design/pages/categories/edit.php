...
if (requiredVal($_GET["id"])) {
    $id = $_GET['id'];
    $mycategory = readDb("`categories`", "`id` = '$id'");
...
<div class="container">
    ...
    <div class="row">
        <div class="col-10 mx-auto">
            ...
            <form action="../../../handelers/categories/edit.php?id=<?= $_GET["id"] ?>" method="POST" enctype="multipart/form-data">
                <h3>Edit Info</h3>
                <div class="mb-3">
                    <label for="cat-name"> Category Name</label>
                    <input type="name" value="<?= $mycategory["name"] ?>" name="name" class="form-control" id="cat-name">
                </div>
